...
public:
	 ...
	 */
	static enum indexItem {TITULO = 0, AUTOR = 1, IDENTIFICADOR = 2, PALABRAS = 3, FECHA = 4} tIndexItem;
	...
	/**
	 * retorna true si pudo eliminar el documento de todos los indices, si al menos uno, falló, devuelve false
	 */
	bool removeFromAll(Document b);
...
private:
	...
	ClassifBPlusTree* titulo; // FIXME pide un facade a gritos
